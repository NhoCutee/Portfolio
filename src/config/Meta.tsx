...
export const siteConfig = {
  ...
  description:
    'Software Engineer & Full Stack Developer specializing in React, Next.js, TypeScript, Node.js, and high-performance web applications.',
